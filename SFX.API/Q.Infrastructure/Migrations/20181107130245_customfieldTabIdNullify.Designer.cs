...
namespace SFX.Infrastructure.Migrations
{
    ...
    [Migration("20181107130245_customfieldTabIdNullify")]
    partial class customfieldTabIdNullify
    {
            ...
            modelBuilder.Entity("SFX.Domain.Asset.AssetType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AddedBy = 1, AddedDate = new DateTime(2018, 11, 7, 13, 2, 45, 420, DateTimeKind.Utc), IsActive = true, IsArchived = false, IsDeleted = false, Name = "Property" }
                    );
                });
            ...
            modelBuilder.Entity("SFX.Domain.Common.RecurrenceType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AddedBy = 1, AddedDate = new DateTime(2018, 11, 7, 13, 2, 45, 420, DateTimeKind.Local), DatePart = "yy", IsActive = true, IsArchived = false, IsDeleted = false, Name = "Annually", RecurrenceNumber = (short)1 },
                        new { Id = 2, AddedBy = 1, AddedDate = new DateTime(2018, 11, 7, 13, 2, 45, 420, DateTimeKind.Local), DatePart = "MM", IsActive = true, IsArchived = false, IsDeleted = false, Name = "Monthly", RecurrenceNumber = (short)1 },
                        new { Id = 3, AddedBy = 1, AddedDate = new DateTime(2018, 11, 7, 13, 2, 45, 420, DateTimeKind.Local), DatePart = "dd", IsActive = true, IsArchived = false, IsDeleted = false, Name = "Daily", RecurrenceNumber = (short)1 }
                    );
                });
            ...
            modelBuilder.Entity("SFX.Domain.Menu.MenuGroup", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AddedBy = 1, AddedDate = new DateTime(2018, 11, 7, 13, 2, 45, 420, DateTimeKind.Utc), IsArchived = false, IsDeleted = false, IsVisible = true, Name = "group" },
                        new { Id = 2, AddedBy = 1, AddedDate = new DateTime(2018, 11, 7, 13, 2, 45, 420, DateTimeKind.Utc), IsArchived = false, IsDeleted = false, IsVisible = true, Name = "item" },
                        new { Id = 3, AddedBy = 1, AddedDate = new DateTime(2018, 11, 7, 13, 2, 45, 420, DateTimeKind.Utc), IsArchived = false, IsDeleted = false, IsVisible = true, Name = "collapsable" }
                    );
                });
            ...
            modelBuilder.Entity("SFX.Domain.User.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AddedBy = 1, AddedDate = new DateTime(2018, 11, 7, 13, 2, 45, 420, DateTimeKind.Utc), IsArchived = false, IsDeleted = false, RoleName = "admin" }
                    );
                });
