...
namespace SFX.Infrastructure.Migrations
{
    ...
    [Migration("20181101095222_TabTableChanged")]
    partial class TabTableChanged
    {
            ...
            modelBuilder.Entity("SFX.Core.Domain.Asset.AssetType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AddedBy = 1, AddedDate = new DateTime(2018, 11, 1, 9, 52, 22, 53, DateTimeKind.Utc), IsActive = true, IsArchived = false, IsDeleted = false, Name = "Property" }
                    );
                });
            ...
            modelBuilder.Entity("SFX.Core.Domain.Common.RecurrenceType", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AddedBy = 1, AddedDate = new DateTime(2018, 11, 1, 9, 52, 22, 52, DateTimeKind.Local), DatePart = "yy", IsActive = true, IsArchived = false, IsDeleted = false, Name = "Annually", RecurrenceNumber = (short)1 },
                        new { Id = 2, AddedBy = 1, AddedDate = new DateTime(2018, 11, 1, 9, 52, 22, 53, DateTimeKind.Local), DatePart = "MM", IsActive = true, IsArchived = false, IsDeleted = false, Name = "Monthly", RecurrenceNumber = (short)1 },
                        new { Id = 3, AddedBy = 1, AddedDate = new DateTime(2018, 11, 1, 9, 52, 22, 53, DateTimeKind.Local), DatePart = "dd", IsActive = true, IsArchived = false, IsDeleted = false, Name = "Daily", RecurrenceNumber = (short)1 }
                    );
                });
            ...
            modelBuilder.Entity("SFX.Core.Domain.Menu.MenuGroup", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AddedBy = 1, AddedDate = new DateTime(2018, 11, 1, 9, 52, 22, 53, DateTimeKind.Utc), IsArchived = false, IsDeleted = false, IsVisible = true, Name = "group" },
                        new { Id = 2, AddedBy = 1, AddedDate = new DateTime(2018, 11, 1, 9, 52, 22, 53, DateTimeKind.Utc), IsArchived = false, IsDeleted = false, IsVisible = true, Name = "item" },
                        new { Id = 3, AddedBy = 1, AddedDate = new DateTime(2018, 11, 1, 9, 52, 22, 53, DateTimeKind.Utc), IsArchived = false, IsDeleted = false, IsVisible = true, Name = "collapsable" }
                    );
                });
            ...
            modelBuilder.Entity("SFX.Core.Domain.User.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AddedBy = 1, AddedDate = new DateTime(2018, 11, 1, 9, 52, 22, 53, DateTimeKind.Utc), IsArchived = false, IsDeleted = false, RoleName = "admin" }
                    );
                });
